    ...
    return {
        {
            ...
            attributes = {
                ...
                scale = string.format("%f %f %f", 1 / params.BASE_OBJ_SCALE.x /
                                          params.QUALITY, 1 /
                                          params.BASE_OBJ_SCALE.z /
                                          params.QUALITY, 1 /
                                          params.BASE_OBJ_SCALE.y /
                                          params.QUALITY),
                childForceExpandWidth = true,
                childForceExpandHeight = false,
                childAlignment = "UpperLeft",
                padding = string.format("%s %s %s %s", 0, 0, 0,
                                        12 * params.QUALITY),
                color = "white"
            },
            children = {
                {
                    ...
                    attributes = {
                        ...
                        spacing = spacing,
                        padding = string.format("%s %s %s %s", spacing, spacing,
                                                0, 0)
                    },
                    children = {
                        {
...
function onButtonClickJsonLoad()
    ...
    object.UI.setAttribute(jsonInputFieldId, "text", jsonInput)
end
...
function onJsonInputEdit(_, value) jsonInput = value end
